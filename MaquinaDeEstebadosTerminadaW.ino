...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
//Declaracion tareas 
AsyncTask readTHfunct_Task(1000, true, readTHfunct); //cambie de 2500 a 3200
AsyncTask readLuzTask(1000, true, readLuzdfunct);
AsyncTask ledTask(1000, true, LED);
AsyncTask displayDataTask(1000, true, DisplayData);
//Retardos---------------
